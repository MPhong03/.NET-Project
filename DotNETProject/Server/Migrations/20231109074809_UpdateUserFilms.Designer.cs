...
namespace DotNETProject.Server.Migrations
{
    ...
    [Migration("20231109074809_UpdateUserFilms")]
    partial class UpdateUserFilms
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotNETProject.Server.Models.Nation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DotNETProject.Server.Models.Film", b =>
                {
                    b.HasOne("DotNETProject.Server.Models.Nation", "Nation")
                        .WithMany()
                        .HasForeignKey("NationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DotNETProject.Server.Models.User", null)
                        .WithMany("Films")
